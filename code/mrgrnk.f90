!
! External code for ranking the array, i.e. returning the permutation
! needed for sorting the array
!
! Source: http://www.fortran-2000.com/rank/mrgrnk.f90 (12. 08. 2018)
!
