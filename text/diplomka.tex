...
Dělení grafu lze využít jako nástroj pro paralelizaci problémů, které lze převést na úlohy na grafech. Vzhledem ke vztahu matic a grafů popsanému výše v odstavci \ref{GrMatRel} je Choleského rozklad popsaný v kapitole \ref{SymElCholDec},
