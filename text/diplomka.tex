...
V této podkapitole bude popsán vstupní formát matice a způsob, kterým tuto matici ukládáme v našem programu. 
...
Matice je v našem programu uložena v CSR formátu (compressed sparse row format) \cite{pis:84,saad:94}.
