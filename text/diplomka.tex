...
Díky Algoritmu \ref{nonzerosAlgorithm} dostáváme odpověď na~otázku, jak zjistit počet nenulových prvků v~matici $L$ z~eliminačního stromu matice $A$. Pokud bychom eliminační strom vytvářeli přímo podle definice, museli bychom vypočítat Choleského rozklad. Proto potřebujeme algoritmus, který nám sestrojí Eliminační strom -- tedy vektor $\texttt{PARENT}$ -- bez toho.
