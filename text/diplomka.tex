...
Námi zvolený algoritmus pro přesouvání vrcholů taktéž není vhodný pro grafy s velmi malým počtem vrcholů, protože u grafů tohoto typu často dojde přesunutím separátoru výrazné změně velikostí jednotlivých částí. To má za následek výraznou nevyváženost v počtu operací potřebných k výpočtu Choleského rozkladu příslušných podmatic.

\TODO{příklad = tabulka bcsstk01.rsa}
...
pro male/ploche to nema cenu
chce to rovnat v kazdem tahu
pro vyvazene to nema cenu bcsstk16
U nevyvazenych to pomaha
separator se trosku zvetsuje, ale ne moc
perioda, ne nutne 2
